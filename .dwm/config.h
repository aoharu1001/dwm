...
static const char *fonts[]               = { "JetBrainsMono Nerd Font:style=medium:size=18", "monospace:size=18" };
...
static const char *tags[] = { 
    ...
    "", // tag:4  key:9  desc:terminal4
    "", // tag:5  key:c  desc:terminal5
    "", // tag:6  key:m  desc:terminal6
    "", // tag:7  key:0  desc:terminal7
    "", // tag:8  key:w  desc:terminal8
    "", // tag:9  key:l  desc:terminal9
};
...
static const Rule rules[] = {
    ...
    /** 普通优先度 */
    {"obs",                  NULL,                 NULL,             0,            0,          0,          0,        -1,      0}, // obs                
    {"chrome",               NULL,                 NULL,             0,            0,          0,          0,        -1,      0}, // chrome             
    {"Chromium",             NULL,                 NULL,             0,            0,          0,          0,        -1,      0}, // Chromium           
    {"music",                NULL,                 NULL,             0,            1,          0,          1,        -1,      0}, // music               浮动、无边框
...
static Key keys[] = {
    ...
    { MODKEY|Mod1Mask,     XK_l,            resizewin,        {.ui = H_EXPAND} },        /* super alt l        |  调整窗口 */
  	...
  	{ MODKEY,              XK_Up,           focusdir,         {.i = UP } },              /* super up           | 二维聚焦窗口 */
